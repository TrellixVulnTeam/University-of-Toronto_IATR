...
class Sack:
    ...
    def __init__(self):
        ...
        # two possible ways of representing this onfo
        # 1. a dictionary with some kind of generated key
        # where the values are the elements in the Sack (you may not
        # get the behavior you want with int keys -
        # but you could use tuples of ins eg. (0, 0 ), (0, 1), (0, 2)....)

        # 2. a list where the elements are stored in order
        # and we randomly choose an index to remove
