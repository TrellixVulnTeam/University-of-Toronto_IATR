...
class TestCar(unittest.TestCase):
    ...
    def test_dispatch_no_ok_car(self):
        self.manager.dispatch(10, 20)
        self.assertEqual(self.manager.get_car_position('car1'), (0, 0))
    ...
    def test_dispatch_has_ok_car(self):
        self.manager.dispatch(10, 10)
        self.assertEqual(self.manager.get_car_position('car1'), (0, 0))
        self.assertEqual(self.manager.get_car_position('car2'), (0, 0))
        self.assertEqual(self.manager.get_car_position('car3'), (10, 10))
        self.assertEqual(self.manager.get_car_fuel('car1'), 2)
        self.assertEqual(self.manager.get_car_fuel('car2'), 10)
        self.assertEqual(self.manager.get_car_fuel('car3'), 0)

    def test_dispatch_has_conflict_car(self):
        self.manager.dispatch(1, 1)
        self.assertEqual(self.manager.get_car_position('car1'), (1, 1))
        self.assertEqual(self.manager.get_car_position('car2'), (0, 0))
        self.assertEqual(self.manager.get_car_position('car3'), (0, 0))
    ...
    def test_dispatch_has_closet_car(self):
        self.manager.move_car('car2', 3, 3)
        self.manager.move_car('car3', 6, 6)
        self.manager.dispatch(4, 4)
        self.assertEqual(self.manager.get_car_position('car1'), (0, 0))
        self.assertEqual(self.manager.get_car_position('car2'), (4, 4))
        self.assertEqual(self.manager.get_car_position('car3'), (6, 6))
        self.assertEqual(self.manager.get_car_fuel('car1'), 2)
        self.assertEqual(self.manager.get_car_fuel('car2'), 2)
        self.assertEqual(self.manager.get_car_fuel('car3'), 8)
