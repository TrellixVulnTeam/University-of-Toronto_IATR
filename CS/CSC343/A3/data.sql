insert into Customer values ('Sofia Jan', 24, 'j.s@mail.com'),
  ('Atena Najm', 39, 'a.n@mail.com'), ('Yu Chang', 42, 'y.c@mail.com'),
  ('Ryan King', 52, 'r.k@mail.com'),('Thomas George', 34, 't.g@gmail.com'),
  ('Marie Smith',22,'ma.smith@mail.com'),('Jonah Swartz',28,'jj.swtz@mail.com'),
  ('Terry Su', 31, 'terry.su@mail.com'),('David Chen', 45, 'dchen@mail.com'),
  ('Cynthia Nguyen', 27, 'cyngu@mail.com'), ('Malik Abdullah', 27, 'malik_aa@mail.com'),
  ('John Parkinson', 33, 'jparki@mail.com'), ('Stan Orlowski', 26, 'orlows@mail.com'),
  ('Sanja Hilbert', 23, 's.hilbert@mail.com'), ('Ian Hsu', 41, 'shenian@mail.com');

insert into Model values (1,'BMW X5', 'SUV', 415, 5),（2,'Mercedes E400', 'Luxury', 1848,4),
  (3,'Chevrolet Spark', 'Economy', 1521,4), (4, 'Dodge Grand Caravan', 'Mini Van',2210,7),
  (5,'Chevrolet Suburban','SUV',1121,8),(6,'Toyota Inception','Sports',1631,2),
  (7,'Volvo V231', 'Economy', 1737,4),(8,'T21','Economy',1221,4);
...
insert into Car values (101,'torc566',1001,1), (102,'torc212',1001,8),(103,'torc631',1001,7),
  (104,'torc522',1001,4),(105,'torbb10',1002,2),(106,'torbb11',1002,7),(107,'torbb12',1002,8),
  (108,'tory011',1003,3),(109,'tory016',1003,4),(110,'tory017',1003,5),(111,'tory101',1004,5),
  (112,'tory102',1004,7),(113,'ottp111',1005,2),(114,'ottp112',1005,7),(115,'ottp113',1005,8),
  (116,'otta101',1006,1),(117,'otta102',1006,7),(118,'otta103',1006,6),(119,'mocs300',1007,3),
  (120,'mocs302',1007,7),(121,'mocs303',1007,7),(122,'mono201',1008,8),(123,'mono202',1008,4),
  (124,'mono203',1008,5),(125,'mowe501',1009,8),(126,'mowe502',1009,8),(127,'mowe503',1009,7),
  (128,'mowe504',1009,1);
...
insert into Customer_reservation values ('j.s@mail.com',22001),('terry.su@mail.com',22001),
  ('s.hilbert@mail.com',22002),('s.hilbert@mail.com',22003),
  ('dchen@mail.com',22004),('jj.swtz@mail.com',22005),
  ('r.k@mail.com',22006),('cyngu@mail.com',22006),
  ('ma.smith@mail.com',22007),('jparki@mail.com',22007),
  ('ma.smith@mail.com',22008),('jparki@mail.com',22008),
  ('orlows@mail.com',22009),('j.s@mail.com',22010),
  ('malik_aa@mail.com',22011),('malik_aa@mail.com',22012),
  ('jparki@mail.com',22013),('shenian@mail.com',22014),
  ('shenian@mail.com',22015),('shenian@mail.com',22016),
  ('shenian@mail.com',22017),('orlows@mail.com',22018),
  ('t.g@gmail.com',22019),('t.g@gmail.com',22020),
  ('t.g@gmail.com',22021),('orlows@mail.com',22022),
  ('s.hilbert@mail.com',22023),('s.hilbert@mail.com',22024),
  ('y.c@mail.com',22025),('y.c@mail.com',22026),
  ('y.c@mail.com',22027),('cyngu@mail.com',22028),
  ('dchen@mail.com',22029),('shenian@mail.com',22030),
  ('dchen@mail.com',22030),('y.c@mail.com',22030),
  ('t.g@gmail.com',22031),('malik_aa@mail.com',22032),
  ('a.n@mail.com',22032),('malik_aa@mail.com',22033),
  ('a.n@mail.com',22033),('terry.su@mail.com',22034),
  ('jj.swtz@mail.com',22035),('cyngu@mail.com',22036),
  ('s.hilbert@mail.com',22037),('s.hilbert@mail.com',22038);
