...
select country, COALESCE(num_elections, 0) as num_elections, COALESCE(num_repeat_party, 0) as num_repeat_party, COALESCE(num_repeat_pm, 0) as num_repeat_pm
from res_num_elections NATURAL FULL JOIN res_num_repeat_party NATURAL FULL JOIN new_res_pm;
