...
if __name__ == "__main__":
    ...
    # print '--------------------------------------'
    model.predict_next_word("government", "of", "united", 10)
    # language_model.find_occurrences("government", "of", "united")
    #
    # print '--------------------------------------'
    # model.predict_next_word("city", "of", "new", 10)
    # language_model.find_occurrences("city", "of", "new")
    # print '--------------------------------------'
    # model.predict_next_word("life", "in", "the", 10)
    # language_model.find_occurrences("life", "in", "the")
    # print '--------------------------------------'
    # model.predict_next_word("he", "is", "the", 10)
    # language_model.find_occurrences("he", "is", "the")
    #model.tsne_plot()
    # a = model.word_distance('government','political')
    # b = model.word_distance('government','university')
    # print a
    # print b
