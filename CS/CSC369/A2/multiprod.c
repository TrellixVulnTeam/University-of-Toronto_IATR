...
int main(int argc, char *argv[])
{
	...
	size_t size  = strtoul(argv[1], NULL, 10); //number of messages in one backend
	size_t nprod = strtoul(argv[2], NULL, 10); //number of producers
	size_t nmsgs = strtoul(argv[3], NULL, 10); //number of messages for each producer to send
