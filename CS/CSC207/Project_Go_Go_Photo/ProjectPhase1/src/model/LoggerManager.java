 ...
 *
 * @see LogMessage, Image
 */
public class LoggerManager {

    /**
     * This method read the log history into an ArrayList of LogMessage(an object with attributes of time and content
     ...
     * @throws IOException
     */
    public static ArrayList<LogMessage> ReadLogMessages(Logger logger, String path) throws ClassNotFoundException, IOException{
