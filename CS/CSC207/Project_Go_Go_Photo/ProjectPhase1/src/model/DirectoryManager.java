...
/**
 * Generate a collection of image files located in or anywhere under the selected directory
...
public class DirectoryManager {
    /**
     * Construct a new DirectroyManager
     */
    public DirectoryManager(){
    }

    /**
     * Return a list of image files located in the selected Directory.
    ...
    /**
     * Return any image files existed under selected file(including the ones in the sub-directories under
