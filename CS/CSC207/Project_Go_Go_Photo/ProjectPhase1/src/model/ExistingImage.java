...
/**
 * This class if created to assist DirectoryManager class to display the
 * name information and path information an image possesses.
 *
 * @see DirectoryManager
 */
public class ExistingImage {
    /**
     * The name(including noth file name and file name extension of this ExistingImage
     */
    private String name;
